  ...
  <div class="card-body">
    <div class="row g-3 align-items-end">
      ...
      <div class="col-md-2 d-flex gap-2">
        ...
        <button class="btn btn-outline-secondary" onclick="resetFilters()"><i class="ri-refresh-line"></i></button>
      </div>
    </div>
  </div>
</div>
...
<div class="row g-3 mb-4">
  <div class="col-md-4">
    <div class="stat-card bg-stat-3">
      <div><div class="stat-val" id="totProfit">–</div><div class="stat-label">Total Profit (filtered)</div></div>
      <div class="stat-icon"><i class="ri-money-dollar-circle-line"></i></div>
    </div>
  </div>
  <div class="col-md-4">
    <div class="stat-card bg-stat-2">
      <div><div class="stat-val" id="totSms">–</div><div class="stat-label">Total SMS (filtered)</div></div>
...
<div class="card">
  <div class="card-header">Profit Breakdown</div>
...
function initTable() {
    ...
    profitTable = $('#profitTable').DataTable({
        ...
        columns: [null,null,null,null,null].map(() => ({data:null,defaultContent:'–'})),
        pageLength: 25,
...
$extraJs = '<script>var APP_URL = "' . APP_URL . '";</script>' . $extraJs;
